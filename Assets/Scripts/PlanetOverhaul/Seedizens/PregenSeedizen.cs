...
public class PregenSeedizen : MonoBehaviour {

	public static bool flingWithMouse = false;

	public PregenPlanet currentPlanet;
	public PregenPlanet destinationPlanet;
	public PregenPlanet startPlanet;


	public PregenVine currentVine;
	...
	void OnCollisionEnter2D (Collision2D col) {
		...
		var v = col.gameObject.GetComponent <PregenVine> ();
		if (v != null) {
		...
		var p = col.gameObject.GetComponent <PregenPlanet> ();
		if (p != null) {
