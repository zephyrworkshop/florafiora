...
public class TravelVineDrag : MonoBehaviour {
	...
	static TravelVineDrag instance;
	...
	public static void StartVineDrag(TravelVine vc)
	{
	...
	void OnDragRelease(Vector3 dir)
	{
		...
		List<PregenSeedizen> seedizensCopy = new List<PregenSeedizen>(vine.seedizens);
