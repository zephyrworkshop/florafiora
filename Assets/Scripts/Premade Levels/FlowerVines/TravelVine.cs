...
public class TravelVine : MonoBehaviour
{
	...
	public TravelPlanet flowerPlanet;
	...
	void OnMouseDown ()
	{
		...
		if (TravelVineDrag.vineCut == false)
		{
			//TravelVineDrag.StartVineDrag(this);
		} else
		{
			VineDelete ();
		}
	...
	{
		TravelVineDrag.StartVineDrag (this, dragSeedizen);
	}*/
